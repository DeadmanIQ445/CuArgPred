...
class CuBertTokenizer(abc.ABC):
  ...
  """
    ...
    def tokenize(self, source_code, labels):
        """Tokenizes via `tokenize_and_abstract`."""
        try:
            agnostic = self.tokenize_and_abstract(source_code, labels)
        ...
        subtokens, labeled = unified_tokenizer.flatten_subtoken_lists(multi_tokens)
